...
- ~~The §3–§6 → AWS-format expressibility mapping~~ — **delivered as [Appendix A](0001-appendix-a-expressibility-mapping.md) (first pass, 2026-08-08)**; before it may be cited in the Decision, its §8 verification items must close (pin a commit of the AWS spec, re-read the four files unsummarized, re-verify the byte arithmetic).
