...
Consequence for this question: a partial confirmation of the first half of "what closes it" from a credible practitioner, with no counterexample offered; the extension half is unanswered. A follow-up comment pressing the encode-only extension case is pending.
