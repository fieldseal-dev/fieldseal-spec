...
- One more arrives with suite `0.4.0-provisional` (G19): the `normalizer-collapses-e-acute` pair described in §3's changelog, pinning canonical equivalence with the exact pair spec §7.5 cites.
