...
**Status:** OPEN — filed, not decided. The Django adapter keeps its refusal (the conservative reading of §10.2 as written) and the Prisma adapter keeps its measured serve until this resolves; the disagreement is the reason the issue exists.
