...
core/
  ...
  java/                   the Phase 2 Java core (docs/27), at stage S4a: Gradle scaffold,
                          CI jobs, capability audit, envelope codec, registry, errors
                          and the crypto primitives; no public client yet
