...
core/
  ...
  java/                   the Phase 2 Java core (docs/27), at stage S4: codec, registry,
                          errors, crypto pipeline, key providers and the client; blind
                          indexes (S5) and the conformance report (S6) not yet
